  ...
  return (
    <main className="site-shell collection-page-shell">
      ...
      <section className="collection-hero">
        ...
        {authenticated ? (
          <div className="collection-progress" aria-label={t('collection.readProgress', progress)}>
            <strong>{t('collection.readProgress', progress)}</strong>
            <span>{progress.percentage}%</span>
            <i><b style={{ width: `${progress.percentage}%` }} /></i>
          </div>
        ) : (
              ...
              <a className="collection-book-main" href={`/book/${item.workId}`}>
                ...
                <span className="collection-book-copy">
                  {collection.collectionType === 'series' && item.sequenceNumber !== null && (
                    <small>{t('collection.bookOf', { position: item.sequenceNumber, total: books.length })}</small>
                  )}
